...
function chart1() {
    var ch= [9, 18, 54, 60, 70, 50,12,15,9,50,80,40];
    ...
    var options = {
        ...
        {
            name: "Low - 2019",
            data: [20, 11, 30, 18, 25, 13,18,50,40,60,22,15]
        },
            {
                name: "Low - 2019",
                data: ch
    ...
    fetch("getchartinfo").then((resp)=>resp.json()).then((json)=>{
        ...
        var chart = new ApexCharts(document.querySelector("#chart1"), optionsss);
